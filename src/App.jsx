    ...
    <div className="min-h-screen bg-white font-sans text-gray-900 selection:bg-fuchsia-200">
      ...
      <section className="relative bg-gradient-to-b from-slate-900 via-slate-900 to-fuchsia-900 text-white pb-12 pt-8 px-4 overflow-hidden">
        <div className="max-w-md mx-auto text-center space-y-6">
          ...
          {/* Badge */}
          <span className="inline-block bg-fuchsia-500/20 text-fuchsia-300 text-xs font-bold px-3 py-1 rounded-full border border-fuchsia-500/50 mb-2">
          ...
          <p className="text-slate-300 text-lg leading-snug">
            Descubra o <b>Protocolo FX de 30 Dias</b> para destravar seus resultados, empinar o glúteo e definir as pernas. Sem "treino fofo".
          </p>

          {/* Elemento Visual (Video Placeholder) */}
          <div className="relative w-full aspect-video bg-slate-800 rounded-xl shadow-2xl border border-slate-700 flex items-center justify-center overflow-hidden group cursor-pointer my-6">
            ...
            {/* Imagem de fundo simulada (substituir por <img> real) */}
            <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1534438327276-14e5300c3a48?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80')] bg-cover bg-center opacity-50"></div>
            
            <div className="relative z-10 bg-fuchsia-600 rounded-full p-4 shadow-[0_0_30px_rgba(192,38,211,0.6)] animate-pulse">
              <Play fill="white" className="text-white ml-1" size={32} />
            </div>
            <p className="absolute bottom-4 text-xs font-bold text-white tracking-widest uppercase">Assista ao vídeo curto</p>
          </div>

          {/* Botão CTA Pulsante */}
          <a href="#offer" className="block w-full bg-gradient-to-r from-green-500 to-green-600 hover:from-green-400 hover:to-green-500 text-white font-black text-xl py-4 rounded-lg shadow-[0_4px_14px_0_rgba(74,222,128,0.39)] transition-transform hover:-translate-y-1 active:scale-95 text-center uppercase tracking-wide">
            Quero Definir Agora <br/>
            <span className="text-sm font-medium opacity-90 normal-case">Por apenas R$ 10,00</span>
          </a>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-md mx-auto space-y-6 text-center">
          ...
          <p className="text-slate-600 leading-relaxed">
            A culpa não é sua genética. O problema é que você está seguindo a <b>"ficha de padaria"</b> que o instrutor passa para todo mundo.
          </p>
          <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500 text-left space-y-3">
            <p className="flex items-start gap-2 text-slate-700 text-sm">
              <span className="text-red-500 font-bold">✕</span> Você treina sem intensidade real.
            </p>
            <p className="flex items-start gap-2 text-slate-700 text-sm">
              <span className="text-red-500 font-bold">✕</span> Você não ativa o glúteo corretamente.
            </p>
            <p className="flex items-start gap-2 text-slate-700 text-sm">
              <span className="text-red-500 font-bold">✕</span> Você perde tempo com exercícios inúteis.
            </p>
          </div>
        </div>
      </section>

      {/* 4. A SOLUÇÃO (BENEFÍCIOS) */}
      <section className="py-12 px-4 bg-slate-50 border-t border-slate-200">
        <div className="max-w-md mx-auto">
          <h2 className="text-2xl font-bold text-center text-slate-900 mb-8">
            O Protocolo FX é a <span className="text-fuchsia-600">chave virada</span> que faltava.
          </h2>
          
          <div className="space-y-4">
            {[
              "Fichas Ilustradas Passo a Passo (Só copiar e colar)",
              "Foco Total em Glúteo Médio e Máximo (Bumbum na nuca)",
              "Divisão de Treino Inteligente (Descanso x Estímulo)",
      ...
      <section id="offer" className="py-14 px-4 bg-slate-900 text-white text-center relative overflow-hidden">
        ...
        <div className="max-w-md mx-auto relative z-10">
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
            ...
            {/* Main CTA */}
            <button className="w-full bg-green-500 hover:bg-green-400 text-white font-black text-xl py-5 rounded-lg shadow-[0_0_20px_rgba(34,197,94,0.6)] transition-all hover:scale-105 mb-4 uppercase">
          ...
          <div className="space-y-4">
            ...
            <details className="group bg-slate-50 p-4 rounded-lg cursor-pointer">
              ...
              <p className="text-slate-600 text-sm mt-3">
                Imediatamente após a confirmação do pagamento, você receberá um e-mail com o link para baixar todo o material.
              </p>
            </details>
            ...
            <details className="group bg-slate-50 p-4 rounded-lg cursor-pointer">
              ...
              <p className="text-slate-600 text-sm mt-3">
                Sim! O protocolo tem explicações detalhadas para quem está começando e técnicas avançadas para quem já treina.
              </p>
            </details>
          </div>
      ...
      <footer className="bg-slate-900 py-8 px-4 border-t border-slate-800">
        <div className="max-w-md mx-auto text-center space-y-4">
          <p className="text-slate-500 text-xs">
            © 2024 Protocolo FX. Todos os direitos reservados.
          </p>
